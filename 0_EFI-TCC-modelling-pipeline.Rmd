...
# test-fitted
tunedModel_svm_m2_test_eps = predict(
  tuneResult_svm_m2_train_eps,
  X_test_m2, y_test_m2)
#performance metrics
...
writeRaster(tunedModel_svm_m2_to_raster, filename = "./Results/Raster/tunedModel_svm_m2_to_raster.tif", format="GTiff")
...
writeRaster(tunedModel_rf_m2_to_raster, filename = "./Results/Rasters/tunedModel_rf_m2_to_raster.tif", overwrite=TRUE)
...
tunedModel_svm_m2_to_raster = raster::raster("./Results/Rasters/tunedModel_svm_m2_to_raster.tif")
