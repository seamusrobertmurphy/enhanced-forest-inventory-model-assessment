...
library(Rcpp)
library(tinytex)
#install json plug-in if needed:
...
## Import permanent sample plots in .csv format
...
## Import AOI shapefile from BC Geographic Warehouse
...
## Import VRI layers from BC Geographic Warehouse to derive species, stems, and mask rasters
...
```{r eval=TRUE, echo=TRUE, error=FALSE, fig.show="hold", message=FALSE, warning=FALSE, cache=TRUE, out.width="33%"}
library(raster)
library(terra)
